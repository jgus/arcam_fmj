...
class State:
    ...
    # FM_SCAN (0x23)
    async def fm_scan(self, up: bool = ...) -> None: ...
    # DAB_SCAN (0x24)
    ...
    async def write_input_config(
        ...
        *,
        input_name: str | None = ...,
        lipsync_delay: float | None = ...,
        decode_mode_2ch_per_source: DecodeMode2CHPerSource | None = ...,
        decode_mode_mch_per_source: DecodeModeMCHPerSource | None = ...,
        bass_equalization: float | None = ...,
        treble_equalization: float | None = ...,
        room_equalization: RoomEqMode | None = ...,
        input_trim: InputTrim | None = ...,
        dolby_audio: DolbyAudioMode | None = ...,
        stereo_mode: StereoMode | None = ...,
        sub_stereo_trim: float | None = ...,
        imax_enhanced: ImaxEnhancedMode | None = ...,
        auro_matic_3d: AuroMatic3DPreset | None = ...,
        auro_matic_strength: int | None = ...,
        select_analog_digital: AnalogueDigitalSelect | None = ...,
        cd_direct: bool | None = ...,
    ) -> None: ...
    # ROOM_EQ_NAMES (0x34)
    ...
    def get_select_analog_digital(self) -> AnalogueDigitalSelect | None: ...
    async def set_select_analog_digital(self, value: AnalogueDigitalSelect) -> None: ...
    # IMAX_ENHANCED (0x0C)
    ...
    async def set_input_name(self, value: str) -> None: ...
    ...
    async def set_decode_mode_2ch_per_source(self, value: DecodeMode2CHPerSource) -> None: ...
    # DECODE_MODE_MCH_PER_SOURCE (0x280C)
    def get_decode_mode_mch_per_source(self) -> DecodeModeMCHPerSource | None: ...
    async def set_decode_mode_mch_per_source(self, value: DecodeModeMCHPerSource) -> None: ...
    # INPUT_TRIM (0x2810)
    def get_input_trim(self) -> InputTrim | None: ...
    async def set_input_trim(self, value: InputTrim) -> None: ...
    # STEREO_MODE (0x2812)
    def get_stereo_mode(self) -> StereoMode | None: ...
    async def set_stereo_mode(self, value: StereoMode) -> None: ...
    # AURO_MATIC_3D (0x2815)
    def get_auro_matic_3d(self) -> AuroMatic3DPreset | None: ...
    async def set_auro_matic_3d(self, value: AuroMatic3DPreset) -> None: ...
    # AURO_MATIC_STRENGTH (0x2816)
    def get_auro_matic_strength(self) -> int | None: ...
    async def set_auro_matic_strength(self, value: int) -> None: ...
    # CD_DIRECT (0x2818)
    def get_cd_direct(self) -> bool | None: ...
    async def set_cd_direct(self, value: bool) -> None: ...
